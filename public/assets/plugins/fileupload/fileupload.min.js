                ...
                var e = (function (A) {
                    ...
                    function y(A) {
                        ...
                        1 in A && (e.catchLoc = A[1]),
                            2 in A &&
                                ((e.finallyLoc = A[2]), (e.afterLoc = A[3])),
    ...
    return (
        ...
        (function () {
            ...
            function A(A, e) {
                ...
                return (
                    t.initCustomEvent(A, e.bubbles, e.cancelable, e.detail), t
                );
            }
            ...
            function A(e, t) {
                ...
                if (
                    ...
                    (this.options.text.chooseFile =
                        this.options.text.hasOwnProperty("chooseFile")
                            ? this.options.text.chooseFile
                            : "Choose file..."),
                    (this.options.text.browse =
                        this.options.text.hasOwnProperty("browse")
                            ? this.options.text.browse
                            : "Browse"),
                    (this.options.text.selectedCount =
                        this.options.text.hasOwnProperty("selectedCount")
                            ? this.options.text.selectedCount
                            : "files selected"),
                ...
                (this.options.images = this.options.hasOwnProperty("images")
                    ? this.options.images
                    : {}),
                    (this.baseImage = this.options.images.hasOwnProperty(
                        "baseImage"
                    )
                    ...
                    (this.successVideoImage =
                        this.options.images.hasOwnProperty("successVideoImage")
                    ...
                    (this.successFileAltImage =
                        this.options.images.hasOwnProperty(
                            "successFileAltImage"
                        )
                    ...
                    (this.options.presetFiles = this.options.hasOwnProperty(
                        "presetFiles"
                    )
                ...
                B(A, [
                                ...
                                (t.onload = function () {
                                    e.input.multiple ||
                                        ...
                                        A.type.match("image/gif")
                                            ? (e.imagePreview.style.backgroundImage =
                                                  'url("'.concat(
                                                      t.result,
                                                      '")'
                                                  ))
                    ...
                    },
                    {
                        ...
                        value: function (A) {
                            if (!A.length)
                                throw new Error(
                                    "Array must contain at least one file."
                                );
