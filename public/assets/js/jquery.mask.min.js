!(function (e) {
    ...
    function a(i, a) {
        ...
        if ((e.isFunction(i.mask) && (i.mask = i.mask(i)), e.isArray(i.mask))) {
            if (i.mask.length > 1) {
                ...
                return (
                    e.each(
                        i.numericInput ? i.mask.reverse() : i.mask,
                        function (t, a) {
                            o.length > 1 &&
                                (o +=
                                    i.groupmarker.end +
                                    ...
                                    i.groupmarker.start),
                                (o +=
                                    void 0 === a.mask || e.isFunction(a.mask)
                                        ? a
                                        : a.mask);
                        }
                    ),
    ...
    function n(i, a, r) {
        function c(e, t, i) {
            ...
            do
                e === !0 && p().validPositions[l]
                    ? ((o = p().validPositions[l]),
                      ...
                      (a = o.locator.slice()),
                      s.push(
                          i === !0 ? o.input : i === !1 ? n.nativeDef : _(l, n)
                      ))
                    : ((o = v(l, a, l - 1)),
                      (n = o.match),
                      (a = o.locator.slice()),
            ...
            return (
                "" === s[s.length - 1] && s.pop(), (p().maskLength = l + 1), s
            );
        }
        function p() {
            return a;
            ...
            for (
                ...
                !(
                    ...
                    ((r.greedy && i.match.optionalQuantifier !== !0) ||
                        ((i.match.optionality === !1 ||
                            i.match.newBlockMarker === !1) &&
                            i.match.optionalQuantifier !== !0)) &&
                    (void 0 === o.alternation ||
                        o.alternation !== i.alternation ||
                        (void 0 !== i.locator[o.alternation] &&
                            S(
                                i.locator[o.alternation].toString().split(","),
                                s
                            )))
                ) ||
                    (t === !0 &&
                        (null !== i.match.fn ||
                            /[0-9a-bA-Z]/.test(i.match.def))));
                l++
            );
            return i;
        }
            ...
            function n(i, a, o, s) {
                function u(o, s, d) {
                    ...
                    if (c === t && void 0 === o.matches)
                        return (
                            f.push({ match: o, locator: s.reverse(), cd: v }),
                            !0
                        );
                    if (void 0 !== o.matches) {
                        if (o.isGroup && d !== o) {
                            if (
                                (o = u(
                                    i.matches[e.inArray(o, i.matches) + 1],
                                    s
                                ))
                            )
                                return !0;
            ...
            if (t > -1) {
                if (void 0 === i) {
                    for (
                        var g, y = t - 1;
                        void 0 ===
                            (g = p().validPositions[y] || p().tests[y]) &&
                        y > -1;
        ...
        function P(e, t, i) {
            ...
            for (a = e; a < t; a++)
                d(!0),
                    i[a] !== r.skipOptionalPartCharacter && A(a, i[a], !0, !0);
        }
        function w(e, i, a) {
            switch (r.casing || i.casing) {
                ...
                case "title":
                    ...
                    e =
                        0 === a ||
                        (n && n.input === String.fromCharCode(t.keyCode.SPACE))
                            ? e.toUpperCase()
                            : e.toLowerCase();
            }
            return e;
        ...
        function A(i, a, n, o, s) {
            function l(e) {
                var t = q
                    ? e.begin - e.end > 1 ||
                      (e.begin - e.end === 1 && r.insertMode)
                    : e.end - e.begin > 1 ||
                      (e.end - e.begin === 1 && r.insertMode);
                return t && 0 === e.begin && e.end === p().maskLength
                    ? "full"
                    : t;
            }
            function u(t, a, n) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    return (s.pos = f()), !1;
                                if (
                                    ((S = void 0 !== s.pos ? s.pos : t),
                                    S !== t)
                                )
                                    return (
                                        (s = e.extend(s, A(S, k, !0, o))), !1
                                    );
                            } else if (
                                s !== !0 &&
                                void 0 !== s.pos &&
            ...
            function c(t, i, a) {
                ...
                if (void 0 !== s) {
                    ...
                    e.each(
                        k(v, w ? w.locator : void 0, v - 1),
                        function (n, l) {
                            h = l.locator[s]
                                ? l.locator[s].toString().split(",")
                                : [];
                        ...
                        if (void 0 === p().validPositions[o] && !E(o, !0)) {
                            ...
                            e.each(s, function (e, t) {
                                ...
                                x(
                                    ...
                                    e.extend({}, l, {
                                        input:
                                            l.match.placeholder || l.match.def,
                                    }),
                                    !0
                                );
                        }
                        ...
                        if (void 0 !== g)
                            for (
                                ...
                                if (
                                    ...
                                    h === !1 &&
                                        s[k] &&
                                        s[k].match.def === g.match.def)
                                )
                                    (p().validPositions[k] = e.extend(
                                        !0,
                                        {},
                                        s[k]
                                    )),
                                    ...
                                    (c = x !== !1),
                                        (u = x.caret || x.insert ? f() : k),
                                        (h = !0);
                                } else c = g.generatedInput === !0;
                                if (
                                    (p().maskLength < v && (p().maskLength = v),
                                    c)
                                )
                                    break;
                            }
                ...
                for (i++; i < t; i++)
                    void 0 === p().validPositions[i] &&
                        ...
                        a &&
                            ...
                            I !== !1 &&
                                (p().validPositions[I.pos || i].generatedInput =
                                    !0)));
            }
            n = n === !0;
            var O = i;
            ...
            if (n && e.isFunction(r.onBeforeWrite)) {
                ...
                if (s) {
                    if (s.refreshFromBuffer) {
                        ...
                        P(l === !0 ? l : l.start, l.end, s.buffer || i),
                            (i = b(!0));
                    }
            ...
            if ((d(), (p().p = C(-1)), !n))
                if (r.autoUnmask !== !0) {
                    var y = x().slice(0, C(-1)).join(""),
                        k = c
                            .join("")
                            .match(new RegExp("^" + t.escapeRegex(y), "g"));
                    k &&
                        k.length > 0 &&
                        (c.splice(0, k.length * y.length), (h = C(h)));
                } else h = C(h);
            if (
                (e.each(c, function (t, a) {
                    if (void 0 !== a) {
                        ...
                        if (!u() || n || r.autoUnmask) {
                            ...
                            g = ee.keypressEvent.call(i, o, !0, !1, !0, s + 1);
                        if (
                            !n &&
        ...
        function G(i, a, n, o) {
            ...
            a === t.keyCode.BACKSPACE &&
            (n.end - n.begin < 1 || r.insertMode === !1)
                ? ((n.begin = R(n.begin)),
            ...
            ee = {
                keydownEvent: function (i) {
                    ...
                    if (
                        ...
                        (s === t.keyCode.HOME && !i.shiftKey) ||
                        s === t.keyCode.PAGE_UP
                            ? (i.preventDefault(),
                              D(n, 0, i.shiftKey ? u.begin : 0, !0))
                ...
                pasteEvent: function (t) {
                    ...
                    if (
                        (u ===
                            (q ? x().reverse() : x())
                                .slice(0, l.begin)
                                .join("") && (u = ""),
                        c === (q ? x().reverse() : x()).slice(l.end).join("") &&
                            (c = ""),
                        q && ((i = u), (u = c), (c = i)),
                    ...
                    return (
                        I(
                            ...
                            !1,
                            !1,
                            q ? p.split("").reverse() : p.toString().split("")
                        ),
                ...
                inputFallBackEvent: function (i) {
                    ...
                    if (b().join("") !== n) {
                        ...
                        if (
                            ...
                            (i.keyCode = t.keyCode.BACKSPACE),
                                ee.keydownEvent.call(a, i);
                        i.preventDefault();
                    }
                },
                ...
                focusEvent: function (e) {
                    ...
                    r.showMaskOnFocus &&
                        ...
                        (t.inputmask._valueGet() !== b().join("")
                            ? O(t, b(), C(f()))
                            : X === !1 && D(t, C(f()))),
                        r.positionCaretOnTab === !0 &&
                            ee.clickEvent.apply(t, [e, !0]),
                        (K = b().join(""));
                },
                mouseleaveEvent: function (e) {
                    ...
                    if (
                        ((X = !1),
                        r.clearMaskOnLostFocus && document.activeElement !== t)
                    ) {
                        var i = b().slice(),
                ...
                cutEvent: function (i) {
                    var a = this,
                        ...
                        l = q
                            ? b().slice(r.end, r.begin)
                            : b().slice(r.begin, r.end);
                ...
                return (
                    ...
                    e.each(r, function (i, r) {
                        ...
                        void 0 !== u &&
                            ...
                            (r.inputmask.userOptions = e.extend(
                                !0,
                                {},
                                s.userOptions
                            )),
                ...
                function s(e) {
                    ...
                    for (var a in e.matches) {
                        ...
                        if (
                            ...
                            var r = e.matches[a];
                            e.matches.splice(a, 1),
                                e.matches.splice(n + 1, 0, r);
                        }
                    ...
                    if ((void 0 === a && (a = {}), "string" == typeof i))
                        switch (i) {
                            ...
                            case "hasMaskedValue":
                                return (
                                    !(!r || !r.inputmask) &&
                                    r.inputmask.hasMaskedValue()
                                );
                            case "isComplete":
                                return (
                                    !r ||
                                    !r.inputmask ||
                                    r.inputmask.isComplete()
                                );
                            case "getmetadata":
                                return r && r.inputmask
            ...
            t.extendAliases({
                "dd/mm/yyyy": {
                    ...
                    isInYearRange: function (e, t, i) {
                        if (isNaN(e)) return !1;
                        var a = parseInt(
                                e.concat(t.toString().slice(e.length))
                            ),
                            n = parseInt(
                                e.concat(i.toString().slice(e.length))
                            );
                        return (
                            (!isNaN(a) && t <= a && a <= i) ||
                            (!isNaN(n) && t <= n && n <= i)
                    ...
                    determinebaseyear: function (e, t, i) {
                        ...
                        if (e <= a && a <= t) {
                            for (var s = a.toString().slice(0, 2); t < s + i; )
                                s--;
                            var l = s + i;
                            return l < e ? e : l;
                        }
            ...
            t.extendAliases({
                numeric: {
                    ...
                    postFormat: function (i, a, n) {
                        ...
                        (u = null !== u && 1 === u.length),
                            a >
                                (u ? n.negationSymbol.front.length : 0) +
                                    n.prefix.length &&
                        ...
                        if (
                            ...
                            (c = c.replace(
                                new RegExp(t.escapeRegex(n.suffix) + "$"),
                                ""
                            )),
                            (c = c.replace(
                                new RegExp("^" + t.escapeRegex(n.prefix)),
                                ""
                            )),
                        ...
                        if ((v === -1 && (v = a), h)) {
                            for (
                                i.length = c.length, r = 0, o = c.length;
                                r < o;
                                r++
                            )
                                i[r] = c.charAt(r);
                    ...
                    onBeforeWrite: function (i, a, n, r) {
                        ...
                        if (
                            ...
                            (l = l.replace(r.suffix, "")),
                                (l = l.replace(
                                    new RegExp(
                                        t.escapeRegex(r.groupSeparator),
                                        "g"
                                    ),
                                    ""
                                )),
                            ...
                            if (
                                ...
                                (l = l.replace(
                                    new RegExp(
                                        t.escapeRegex(r.negationSymbol.back) +
                                            "$"
                                    ),
                                    ""
                                )),
                                isNaN(r.placeholder) &&
                                    (l = l.replace(
                                        new RegExp(
                                            t.escapeRegex(r.placeholder),
                                            "g"
                                        ),
                                        ""
                                    )),
                                (l =
                                    l === r.negationSymbol.front ? l + "0" : l),
                                "" !== l && isFinite(l))
                            ) {
                                var c = parseFloat(l),
                                    p = u ? c * -1 : c;
                        ...
                        if (r.autoGroup)
                            return (
                                ...
                                (o.caret =
                                    n <
                                        (o.isNegative
                                            ? r.negationSymbol.front.length
                                            : 0) +
                                            r.prefix.length ||
                                    n >
                                        o.buffer.length -
                                            (o.isNegative
                                                ? r.negationSymbol.back.length
                                                : 0)
                                        ? o.pos
                                        : o.pos + 1),
                                o
                    ...
                    definitions: {
                        ...
                        ":": {
                            validator: function (e, i, a, n, r) {
                                ...
                                if (!o) {
                                    var s =
                                        "[" + t.escapeRegex(r.radixPoint) + "]";
                                    (o = new RegExp(s).test(e)),
                                        o &&
                                            i.validPositions[a] &&
                                            i.validPositions[a].match
                    ...
                    onUnMask: function (e, i, a) {
                        ...
                        return (
                            ...
                            (n = n.replace(
                                new RegExp(
                                    t.escapeRegex(a.groupSeparator),
                                    "g"
                                ),
                                ""
                            )),
                    ...
                    isComplete: function (e, i) {
                        ...
                        return (
                            ...
                            (r = r.replace(
                                new RegExp(
                                    t.escapeRegex(i.groupSeparator),
                                    "g"
                                ),
                                ""
                            )),
