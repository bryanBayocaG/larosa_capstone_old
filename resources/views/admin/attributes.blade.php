        ...
        <div class="page-wrapper">
            <div class="col-lg-12 col-sm-12 tabs_wrapper">
                <ul class=" tabs owl-carousel owl-theme owl-product  border-0 " style="margin-left: 5%">

                    <li class="active" id="category">
                        <div class="product-details ">
                            <h6>Set Categories</h6>
                        </div>
                    </li>
                    <li id="item">
                        <div class="product-details ">
                ...
                <div class="tabs_container">
                    ...
                    <div class="tab_content active" data-tab="category">
                        <div class="content">
                    ...
                    <div class="tab_content" data-tab="color">
                        @livewire('colortable')
                    </div>
                    <div class="tab_content" data-tab="size">
                        @livewire('sizetable')
                    </div>
                </div>
            </div>
